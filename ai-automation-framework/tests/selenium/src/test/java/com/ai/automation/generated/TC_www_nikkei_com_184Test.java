...
public class TC_www_nikkei_com_184Test extends BaseTest {

  @Epic("Crawl-derived test cases")
  @Feature("form")
  @Severity(SeverityLevel.CRITICAL)
  @Description("Auto-generated: /search: required field validation\nExpected: Inline validation highlights the empty field; form does not submit")
  @Test(description = "negative | form | /search: required field validation")
  public void test_TC_www_nikkei_com_184() {
    ...
    // Step 2: Leave one required/visible field empty in /search
