...
public class TC_beta_solwerindia_com_95Test extends BaseTest {
  ...
  public void test_TC_beta_solwerindia_com_95() {
    driver.get("https://beta.solwerindia.com/contact-building");
    // Step 1: Attempt to navigate to an invalid path under https://beta.solwerindia.com/contact-building (e.g., /invalid-test-path)
