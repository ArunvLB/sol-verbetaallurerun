...
public class TC_beta_solwerindia_com_112Test extends BaseTest {
  ...
  public void test_TC_beta_solwerindia_com_112() {
    driver.get("https://beta.solwerindia.com/blogs");
    // Step 1: Attempt to navigate to an invalid path under https://beta.solwerindia.com/blogs (e.g., /invalid-test-path)
