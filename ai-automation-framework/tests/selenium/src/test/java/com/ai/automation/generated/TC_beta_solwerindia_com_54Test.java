...
public class TC_beta_solwerindia_com_54Test extends BaseTest {
  ...
  public void test_TC_beta_solwerindia_com_54() {
    driver.get("https://beta.solwerindia.com/brochures");
    // Step 1: Attempt to navigate to an invalid path under https://beta.solwerindia.com/brochures (e.g., /invalid-test-path)
