...
public class TC_www_youtube_com_72Test extends BaseTest {

  @Epic("Crawl-derived test cases")
  @Feature("form")
  @Severity(SeverityLevel.CRITICAL)
  @Description("Auto-generated: /results: required field validation\nExpected: Inline validation highlights the empty field; form does not submit")
  @Test(description = "negative | form | /results: required field validation")
  public void test_TC_www_youtube_com_72() {
    driver.get("https://www.youtube.com/@SolwerIndiaOfficial");
    // Step 1: Open https://www.youtube.com/@SolwerIndiaOfficial
    // Step 2: Leave one required/visible field empty in /results
