...
public class TC_beta_solwerindia_com_128Test extends BaseTest {
  ...
  public void test_TC_beta_solwerindia_com_128() {
    driver.get("https://beta.solwerindia.com/jobs");
    // Step 1: Attempt to navigate to an invalid path under https://beta.solwerindia.com/jobs (e.g., /invalid-test-path)
