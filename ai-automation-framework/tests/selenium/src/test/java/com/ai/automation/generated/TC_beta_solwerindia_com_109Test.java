...
public class TC_beta_solwerindia_com_109Test extends BaseTest {
  ...
  public void test_TC_beta_solwerindia_com_109() {
    driver.get("https://beta.solwerindia.com/contact-building");
    // Step 1: Simulate blocked network for one external script (e.g., via request interception) on https://beta.solwerindia.com/contact-building
