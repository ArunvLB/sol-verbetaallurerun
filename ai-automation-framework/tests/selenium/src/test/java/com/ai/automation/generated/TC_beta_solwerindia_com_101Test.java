...
public class TC_beta_solwerindia_com_101Test extends BaseTest {

  @Epic("Crawl-derived test cases")
  @Feature("interaction")
  @Severity(SeverityLevel.MINOR)
  @Description("Auto-generated: Click \"Submit Application\" triggers expected action\nExpected: Click results in visible action (navigation, modal open, or state change) without JS errors")
  @Test(description = "positive | interaction | Click \"Submit Application\" triggers expected action")
  public void test_TC_beta_solwerindia_com_101() {
    driver.get("https://beta.solwerindia.com/contact-building");
    // Step 1: Locate button "Submit Application" on https://beta.solwerindia.com/contact-building
