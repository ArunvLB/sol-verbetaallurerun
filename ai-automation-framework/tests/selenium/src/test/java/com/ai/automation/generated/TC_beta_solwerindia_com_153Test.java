...
public class TC_beta_solwerindia_com_153Test extends BaseTest {
  ...
  public void test_TC_beta_solwerindia_com_153() {
    driver.get("https://beta.solwerindia.com/contact");
    // Step 1: Simulate blocked network for one external script (e.g., via request interception) on https://beta.solwerindia.com/contact
