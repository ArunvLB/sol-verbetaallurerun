...
public class TC_beta_solwerindia_com_138Test extends BaseTest {

  @Epic("Crawl-derived test cases")
  @Feature("navigation")
  @Severity(SeverityLevel.MINOR)
  @Description("Auto-generated: Load Contact Us - SOLWER India | Get in Touch for Automotive Solutions successfully\nExpected: Page loads within acceptable time and title is not empty; no severe console errors")
  @Test(description = "positive | navigation | Load Contact Us - SOLWER India | Get in Touch for Automotive Solutions successfully")
  public void test_TC_beta_solwerindia_com_138() {
