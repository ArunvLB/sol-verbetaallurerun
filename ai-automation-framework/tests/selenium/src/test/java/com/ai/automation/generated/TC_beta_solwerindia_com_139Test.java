...
public class TC_beta_solwerindia_com_139Test extends BaseTest {
  ...
  public void test_TC_beta_solwerindia_com_139() {
    driver.get("https://beta.solwerindia.com/contact");
    // Step 1: Attempt to navigate to an invalid path under https://beta.solwerindia.com/contact (e.g., /invalid-test-path)
