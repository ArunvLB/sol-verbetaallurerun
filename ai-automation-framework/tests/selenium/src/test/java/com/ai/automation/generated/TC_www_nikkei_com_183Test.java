...
public class TC_www_nikkei_com_183Test extends BaseTest {

  @Epic("Crawl-derived test cases")
  @Feature("form")
  @Severity(SeverityLevel.MINOR)
  @Description("Auto-generated: Submit /search with valid data\nExpected: Submission succeeds with success message or navigation; no validation errors")
  @Test(description = "positive | form | Submit /search with valid data")
  public void test_TC_www_nikkei_com_183() {
    ...
    // Step 2: Fill all inputs in /search with valid sample values
