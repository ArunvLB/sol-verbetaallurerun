...
public class TC_beta_solwerindia_com_34Test extends BaseTest {
  ...
  public void test_TC_beta_solwerindia_com_34() {
    driver.get("https://beta.solwerindia.com/digital-tools");
    // Step 1: Attempt to navigate to an invalid path under https://beta.solwerindia.com/digital-tools (e.g., /invalid-test-path)
