...
public class TC_beta_solwerindia_com_127Test extends BaseTest {

  @Epic("Crawl-derived test cases")
  @Feature("navigation")
  @Severity(SeverityLevel.MINOR)
  @Description("Auto-generated: Load Careers & Jobs  SOLWER India | Join our Team successfully\nExpected: Page loads within acceptable time and title is not empty; no severe console errors")
  @Test(description = "positive | navigation | Load Careers & Jobs  SOLWER India | Join our Team successfully")
  public void test_TC_beta_solwerindia_com_127() {
    driver.get("https://beta.solwerindia.com/jobs");
    // Step 1: Open https://beta.solwerindia.com/jobs
