...
public class TC_beta_solwerindia_com_93Test extends BaseTest {
  ...
  public void test_TC_beta_solwerindia_com_93() {
    driver.get("https://beta.solwerindia.com/news");
    // Step 1: Simulate blocked network for one external script (e.g., via request interception) on https://beta.solwerindia.com/news
