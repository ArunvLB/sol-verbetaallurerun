...
public class TC_beta_solwerindia_com_13Test extends BaseTest {
  ...
  public void test_TC_beta_solwerindia_com_13() {
    driver.get("https://beta.solwerindia.com/solutions");
    // Step 1: Attempt to navigate to an invalid path under https://beta.solwerindia.com/solutions (e.g., /invalid-test-path)
