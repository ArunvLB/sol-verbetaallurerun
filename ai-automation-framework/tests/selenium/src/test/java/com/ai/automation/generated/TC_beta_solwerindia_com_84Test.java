...
public class TC_beta_solwerindia_com_84Test extends BaseTest {
  ...
  public void test_TC_beta_solwerindia_com_84() {
    driver.get("https://beta.solwerindia.com/news");
    // Step 1: Attempt to navigate to an invalid path under https://beta.solwerindia.com/news (e.g., /invalid-test-path)
