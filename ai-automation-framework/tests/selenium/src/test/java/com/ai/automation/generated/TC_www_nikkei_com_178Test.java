...
public class TC_www_nikkei_com_178Test extends BaseTest {

  @Epic("Crawl-derived test cases")
  @Feature("interaction")
  @Severity(SeverityLevel.MINOR)
  @Description("Auto-generated: Click \"button-8\" triggers expected action\nExpected: Click results in visible action (navigation, modal open, or state change) without JS errors")
  @Test(description = "positive | interaction | Click \"button-8\" triggers expected action")
  public void test_TC_www_nikkei_com_178() {
    driver.get("https://www.nikkei.com/article/DGXZQOUC152NQ0V10C26A2000000/");
    // Step 1: Locate button "button-8" on https://www.nikkei.com/article/DGXZQOUC152NQ0V10C26A2000000/
