...
public class TC_beta_solwerindia_com_2Test extends BaseTest {
  ...
  public void test_TC_beta_solwerindia_com_2() {
    driver.get("https://beta.solwerindia.com/");
    // Step 1: Attempt to navigate to an invalid path under https://beta.solwerindia.com/ (e.g., /invalid-test-path)
