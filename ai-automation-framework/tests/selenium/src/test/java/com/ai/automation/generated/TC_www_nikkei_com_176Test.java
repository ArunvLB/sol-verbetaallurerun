...
public class TC_www_nikkei_com_176Test extends BaseTest {

  @Epic("Crawl-derived test cases")
  @Feature("interaction")
  @Severity(SeverityLevel.MINOR)
  @Description("Auto-generated: Click \"button-6\" triggers expected action\nExpected: Click results in visible action (navigation, modal open, or state change) without JS errors")
  @Test(description = "positive | interaction | Click \"button-6\" triggers expected action")
  public void test_TC_www_nikkei_com_176() {
    driver.get("https://www.nikkei.com/article/DGXZQOUC152NQ0V10C26A2000000/");
    // Step 1: Locate button "button-6" on https://www.nikkei.com/article/DGXZQOUC152NQ0V10C26A2000000/
